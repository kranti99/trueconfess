  ...
  return (
    <div className="space-y-6 p-4 bg-gray-900 text-white">
      {confessions.map((confession) => (
        <Link href={`/confession/${confession.id}`} key={confession.id} className="block p-4 bg-gray-800 rounded shadow-lg flex items-start space-x-4 hover:bg-gray-700 transition">
          <Avatar
